...
- [check-torpeers.sh](/check-torpeers.sh): scans through connected peers of a node and tries to switch hybrid peers by disconnecting Tor peers and reconnecting to clearnet addresses.
